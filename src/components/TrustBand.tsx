...
export const TrustBand = () => (
  <section aria-label="Certification trust marks" className="max-w-7xl mx-auto px-4 md:px-12 lg:px-20 mt-4 md:mt-5 mb-3">
    ...
    <ul className="rounded-2xl bg-brand-surface border border-brand-line text-brand-forest flex items-start gap-x-5 md:flex-wrap md:justify-center md:gap-x-9 lg:gap-x-12 gap-y-3 px-4 md:px-6 py-3.5 md:py-4 overflow-x-auto md:overflow-visible no-scrollbar">
      {MARKS.map((m) => (
